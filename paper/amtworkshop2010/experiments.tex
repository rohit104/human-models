...
% and to label images~\cite{imagenet-cvpr09}.
...
\centering
\vspace{-0.10in}
\subfigure[\emph{set1}, $K = 10$]{\includegraphics[width = .22\linewidth]{figures/histogram_1}}%
\subfigure[\emph{set1}, $K = 15$]{\includegraphics[width = .22\linewidth]{figures/histogram_2}}%
\subfigure[\emph{set2}, $K = 10$]{\includegraphics[width = .22\linewidth]{figures/histogram_4}}%
\subfigure[\emph{set2}, $K = 15$]{\includegraphics[width = .22\linewidth]{figures/histogram_3}}%
\caption{The number of HITs performed (y-axis) by each participant (x-axis). Between 12 and 30 people participated in each experiment.}
\label{fig:hists}
\end{figure*}
...
\begin{figure*}
\centering
\subfigure[$K = 10$]{\includegraphics[width = .4\linewidth]{figures/entropy_K10}}%
\subfigure[$K = 15$]{\includegraphics[width = .4\linewidth]{figures/entropy_K15}}
...
interpretations.  For example, the \{\word{november, february,
...
such as \{\word{president, emperor, politican, election,
  government}\} or \{\word{music, pop, records, singer, artist}\}.
Several of the topics are combinations of distinct concepts, such as
\{\word{catholic, church, film, music, actor}\}, which is often
...
anomalous words, such as \{\word{district, town, city, local,
  kolkata}\} or \{\word{school, university, college, election,
...
\mytab{tab:initialize} shows the topics inferred by LDA when
...
Other semantically coherent topics, such as \{\word{located, south,
  site, land, region}\}, have appeared in its place.

\myfig{fig:initialize} shows the log-likelihood course of LDA when
